...
API_URL = "https://ayurgenix-backend.onrender.com"
REQUEST_TIMEOUT = 120
...
with st.sidebar:
    ...
    if healthy:
        ...
        st.caption(f"Model: {health.get('groq_model')}")
    ...
    st.checkbox("⚡ Streaming Response", key="use_streaming")
    ...
    with st.spinner("🧠 Thinking..."):
        try:
            if st.session_state.use_streaming:
                ...
                result = {"answer": full_answer, "confidence": 0.5, "sources": []}
            else:
